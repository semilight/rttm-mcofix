...
public class ConfigGui extends CommonGui {
    ...
    private static final int guiHeight = 226;
    ...
    private static final List<String> skipTooltip = new ArrayList<>();
    ...
    static {
        ...
        colorTooltip.add("Colour of manually re-translated messages and signs.");
        colorTooltip.add("Auto-translations keep the sender's original colours.");
        boldTooltip.add("Bolds manually re-translated messages and signs");
        italicTooltip.add("Italics manually re-translated messages and signs");
        underlineTooltip.add("Underlines manually re-translated messages and signs");
        skipTooltip.add("Languages to be left untranslated in chat");
        skipTooltip.add("Everything else is still translated to your target language");
        signTooltip.add("Translates signs when you right/left click them");
    }
    ...
    private static String skipLabel() {
        int count = ConfigManager.INSTANCE.getSkipLanguages().size();
        if (count == 0) {
            return "None";
        }
    ...
    public void drawScreen(int x, int y, float tick) {
        ...
        fontRenderer.drawString("Never translate:", getLeftMargin(), getYOrigin() + 115, 0x555555);
        fontRenderer.drawString("Preview: ", getLeftMargin(), getYOrigin() + 135, 0x555555);
        fontRenderer.drawString("<Notch> " + ChatUtil.RTTM_TAG + " Hello! §7(English)", getLeftMargin() + 45, getYOrigin() + 135, 0xFFFFFF);
        //Target language
        ...
        if (this.buttonList.size() > 12 && this.buttonList.get(12).isMouseOver())
            drawHoveringText(skipTooltip, x, y);
        //API key
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(12, getRightMargin(regularButtonWidth), getYOrigin() + 110, regularButtonWidth, regularButtonHeight, skipLabel()));
    }
    ...
    public void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            ...
            case 11:
                ...
                break;
            case 12:
                mc.displayGuiScreen(new LanguageSelectGui(this));
                break;
        }
    }
